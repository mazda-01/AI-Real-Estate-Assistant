...
> *(Не забудьте вставить ссылки на два скриншота: один с классификацией фото через YOLO, второй — с чатом RAG)*
> 
> *Пример:*
> `<img src="path_to_yolo_screenshot.png" width="800">`
> `<img src="path_to_rag_chat_screenshot.png" width="800">`

## 🎓 Чему я научился в этом проекте
- Полному циклу интеграции больших языковых моделей (LLM) с векторными базами данных (Qdrant).
- Созданию асинхронных API для инференса ML-моделей с использованием FastAPI.
- Промпт-инжинирингу (Prompt Engineering) и настройке поиска контекста для локализованных данных.
- Разработке удобных пользовательских веб-интерфейсов с использованием Streamlit.
